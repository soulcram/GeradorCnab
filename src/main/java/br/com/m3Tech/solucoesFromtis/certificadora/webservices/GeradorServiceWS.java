...
public class GeradorServiceWS  {
	...
	private final AutenticadorRequestHandler autenticadorRequestHandler;
	private final RetornoHandler retornoHandler;
	
	@Inject
	public GeradorServiceWS(final IConfGlobalService confGlobalService,
			final AutenticadorRequestHandler autenticadorRequestHandler,
			final RetornoHandler retornoHandler) {
		this.confGlobalService = confGlobalService;
		this.autenticadorRequestHandler = autenticadorRequestHandler;
		this.retornoHandler = retornoHandler;
	}
