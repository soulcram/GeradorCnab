...
import br.com.fromtis.fidc.portal.servicos.consulta.soap.CadastroCedenteParaAprovarProxy;
import br.com.fromtis.fidc.portal.servicos.consulta.soap.ContaCorrenteCadCedente;
import br.com.fromtis.fidc.portal.servicos.consulta.soap.ContatoCadCedente;
...
public class CadastrarCedenteParaAprovar implements ICadastroAutomatizado {
	...
	public String executar(ParametrosCadastrosAutomaticos parametros) {
		...
		try {
			...
			String endpoint = "/portal-servicos/servicos/soap/cadastroCedenteParaAprovar?wsdl";
			
			CadastroCedenteParaAprovarProxy service = new CadastroCedenteParaAprovarProxy(parametros.getUrl() + endpoint, parametros.getUsuario(), parametros.getSenha());
			...
			for (int i = 0; i < parametros.getRepeticoes(); i++) {
				...
				String nomeContato = nomeFake.gerarNomeCompleto();
				ContatoCadCedente contato = new ContatoCadCedente(nomeContato, 
						nomeContato.replaceAll(" ", "") + "@gmail.com", 
						 "11987453256"
						 );
				ContatoCadCedente[] contatos = {contato};
			...
			RetornoCadastroCedente[] cadastroCedenteAprovado = service.cadastroCedenteParaAprovar(cs.toArray(new CadastroCedente[0]));
