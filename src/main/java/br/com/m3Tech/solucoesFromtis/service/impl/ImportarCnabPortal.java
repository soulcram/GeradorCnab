...
public class ImportarCnabPortal implements ICadastroAutomatizado {
	...
	public String executar(ParametrosCadastrosAutomaticos parametros) {
		...
		GeradorCpfCnpjRgFake gerarDoc = new GeradorCpfCnpjRgFake();
			...
			driver.get(parametros.getUrl() + "/portal/validador/importarArquivo");
			driver.findElement(By.id("tabelaArquivos")).click();
//			driver.findElement(By.xpath("//*[contains(text(), '"+parametros.getFundo().getNomeFundo()+"')]")).click();
//			driver.findElement(By.xpath("//*[contains(text(), 'Selecionar Arquivo..')]")).click();
//			Select comboFundo = new Select(driver.findElement(By.id("fundo")));
//			List<WebElement> allSelectedOptions = comboFundo.getAllSelectedOptions();
			
			System.out.println();
//			driver.findElement(By.xpath("//*[contains(text(), 'Importar')]")).click();
			
			//*[@id="consultaArquivosImportadosRemessaForm"]/div[2]/div/div/a
