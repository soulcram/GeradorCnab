...
public class Querys {
	...
	public static final String ALL_MOVIMENTOS = "SELECT TM.ID_TIPO_MOVIMENTO, CD_OCORRENCIA, NM_TIPO_MOVIMENTO\r\n" + 
			" FROM TB_LAYOUT_MOVIMENTO LM\r\n" + 
			" INNER JOIN TB_TIPO_MOVIMENTO TM ON TM.ID_TIPO_MOVIMENTO = LM.ID_TIPO_MOVIMENTO\r\n" + 
			" WHERE LM.CD_LAYOUT = ?";
	public static final String ONE_MOVIMENTO = "SELECT TM.ID_TIPO_MOVIMENTO, CD_OCORRENCIA, NM_TIPO_MOVIMENTO\r\n" + 
			" FROM TB_LAYOUT_MOVIMENTO LM\r\n" + 
			" INNER JOIN TB_TIPO_MOVIMENTO TM ON TM.ID_TIPO_MOVIMENTO = LM.ID_TIPO_MOVIMENTO\r\n" + 
			" WHERE ID_TIPO_MOVIMENTO = ?";
